...
describe('auto-export scheduler', () => {
  beforeEach(() => {
    ...
    snapshot.mockResolvedValue({ journal: { entries: [], dimensions: [], presets: [], tagGroups: [], milestones: [], labResults: [], measurements: [], reminders: [] }, files: [], readFile: async () => new Uint8Array() });
