...
/* v4: the regimen episode area (phase 4 ticket 01, CONTEXT: "Regimen
...
/* v5: the dose log (phase 4 ticket 02, CONTEXT: "Dose event").
...
/* v7: medication stock and its run-out prompt (phase 4 ticket 04, CONTEXT:
