/* Icon set — Lucide-style 24px / 2px-stroke outline icons, inlined as SVG and
   coloured via currentColor. In the app these come from lucide-svelte (ISC);
   the mockup inlines the same path data to stay dependency-free.
   Icons never carry meaning alone: navigation and settings pair them with labels. */
